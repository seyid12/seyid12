...
**[Term_Ai](https://github.com/seyid12/Term_Ai)** (Go)
> A high-performance CLI tool built with Go, featuring a streaming architecture to interface seamlessly with multiple AI model providers.

**Movie API** (C# / ASP.NET Core)
...
*   **B.S. Management Information Systems** - Ankara University *(Ongoing)*
*   **A.S. Computer Programming** - Anadolu University
*   **A.S. Medical Documentation and Secretarial Studies** - Atatürk University

🇬🇧 *Actively mastering English to consume global tech documentation and contribute to international projects.*

### 📫 Let's Connect

Open to discussing Backend Architecture, AI Integration, or Linux Environments.
